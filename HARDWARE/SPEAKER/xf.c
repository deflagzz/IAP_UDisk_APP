...
void yinling(u8 num)
{
	switch(num)
	{
		//case 0:PrintCom(YIN_LIANG0,9);osdelay_ms(10);break;
		case 0:
		case 1:
			PrintCom(YIN_LIANG1,9);osdelay_ms(10);
			break;
		case 2:PrintCom(YIN_LIANG2,9);osdelay_ms(10);break;
		case 3:PrintCom(YIN_LIANG3,9);osdelay_ms(10);break;
		case 4:PrintCom(YIN_LIANG4,9);osdelay_ms(10);break;
		case 5:PrintCom(YIN_LIANG5,9);osdelay_ms(10);break;
		case 6:PrintCom(YIN_LIANG6,9);osdelay_ms(10);break;
		case 7:PrintCom(YIN_LIANG7,9);osdelay_ms(10);break;
		case 8:PrintCom(YIN_LIANG8,9);osdelay_ms(10);break;
		case 9:PrintCom(YIN_LIANG9,9);osdelay_ms(10);break;
		default:
			break;
	}                                                                        
}                                 
